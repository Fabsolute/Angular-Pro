...
var QuickFormInputComponent = (function (_super) {
    ...
    QuickFormInputComponent_1 = QuickFormInputComponent;
    QuickFormInputComponent.prototype.ngOnInit = function () {
        ...
        if (this.required) {
            this.control = new forms_1.FormControl(this.form_control_name, [
                ...
                forms_1.Validators.maxLength((this.max_character) ? this.max_character : 100)
            ]);
        }
        else {
            this.control = new forms_1.FormControl(this.form_control_name, [
    ...
    __decorate([
        core_1.Input()
    ], QuickFormInputComponent.prototype, "form_control_name", void 0);
    __decorate([
        core_1.Input()
    ], QuickFormInputComponent.prototype, "label", void 0);
    __decorate([
        core_1.Input()
    ], QuickFormInputComponent.prototype, "required", void 0);
    __decorate([
        core_1.Input()
    ], QuickFormInputComponent.prototype, "min_character", void 0);
    __decorate([
        core_1.Input()
    ], QuickFormInputComponent.prototype, "max_character", void 0);
    __decorate([
        core_1.Input()
    ], QuickFormInputComponent.prototype, "class", void 0);
    __decorate([
        core_1.Input()
    ], QuickFormInputComponent.prototype, "value", void 0);
